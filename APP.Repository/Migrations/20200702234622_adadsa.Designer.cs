...
namespace APP.UI.Data.Migrations
{
    ...
    [Migration("20200702234622_adadsa")]
    partial class adadsa
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("APP.Core.Models.UserCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("APP.Core.Models.Category", b =>
                {
                    b.HasOne("APP.Core.Models.UserCategory", null)
                        .WithMany("Categories")
            ...
            modelBuilder.Entity("APP.Core.Models.UserCategory", b =>
                {
                    b.HasOne("APP.Core.Models.ApplicationUser", "ApplicationUser")
                        ...
                        .HasForeignKey("APP.Core.Models.UserCategory", "UserId");
                });
